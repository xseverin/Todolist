...
namespace Data.Migrations
{
    ...
    [Migration("20240730160320_AddResetPasswordWithNull")]
    partial class AddResetPasswordWithNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.SharedTodo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.SharedTodo", b =>
                {
                    b.HasOne("Domain.ApplicationUser", "SharedByUser")
                        .WithMany()
                        .HasForeignKey("SharedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.ApplicationUser", "SharedWithUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.UserDetail", b =>
                {
                    b.HasOne("Domain.ApplicationUser", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("Domain.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
